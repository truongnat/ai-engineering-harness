...
| repo-structure | [CodeGraph](https://github.com/colbymchenry/codegraph) (`codegraph`) | file tree plus import scan |
...
- Use [CodeGraph](https://github.com/colbymchenry/codegraph) when `codegraph` is installed and the project has a `.codegraph/` index.
