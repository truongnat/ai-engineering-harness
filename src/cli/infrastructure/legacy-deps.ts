...
export const { detectProviderBinaries, listDetectedProviderIds: listDetectedProviderBinaryIds } =
...
export const { runtimeCommandCatalogPathsForPlan, formatCommandSupportForPlan } =
...
export const { runDoctor, runStatus } =
  require("../../features/install/infrastructure/status-doctor.js") as {
