...
- Next planned: `v0.9.0` Stable Contract Freeze ([plan](docs/v0.9.0-plan.md) · [readiness](docs/v0.9.0-readiness.md) · [scope](docs/v0.9.0-release-scope.md) · [contracts](docs/stable-contract-index.md))
