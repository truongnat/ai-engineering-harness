...
Release notes: [docs/v1.1.2-release-notes.md](docs/v1.1.2-release-notes.md)
...
**v1.1.2**: patch release adding a headless `domains` command, removing interactive domain prompts from `init` and `install`, and tightening release-facing version surfaces. All changes are backward-compatible.
